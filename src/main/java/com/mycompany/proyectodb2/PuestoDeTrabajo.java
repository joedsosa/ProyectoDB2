...
public class PuestoDeTrabajo {
    ...
    public String getAntecedentesPenalesPermitidos() { return antecedentesPenalesPermitidos; }
    public void setAntecedentesPenalesPermitidos(String antecedentesPenalesPermitidos) { this.antecedentesPenalesPermitidos = antecedentesPenalesPermitidos; }
